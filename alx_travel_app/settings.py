...
SECRET_KEY = 'django-insecure-n4xk=6765mgkhdpc1l*wxf7j8_yg(j6w8oe80nc$rj9h@isuk8'
...
CELERY_RESULT_BACKEND = "rpc://"        # You can also use Redis if needed
CELERY_ACCEPT_CONTENT = ["json"]
CELERY_TASK_SERIALIZER = "json"
CELERY_RESULT_SERIALIZER = "json"

# Email Configuration (adjust to your provider)
